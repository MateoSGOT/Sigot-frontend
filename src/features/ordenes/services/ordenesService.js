...
export const ordenesService = {
  ...
  // Envía por correo al cliente el mismo comprobante (PDF) que "Comprobante (PDF)" descarga.
  enviarComprobantePorCorreo: (id, pdfBase64) => api.post(`${BASE}/${id}/facturar-correo`, { pdfBase64 }).then(r => r.data),
